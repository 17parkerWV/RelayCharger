...
//These are for dad's voltage probe and pwm signal and ammeter pin
const int pwmPin = 10;
...
void cellSearch();
void stop();
const uint8_t noBattery[4] = { 0b01010100,0b01011100,0b00000000,0b01111100 };
//The one and only useless waste of memory
...
void cellSearch() {
    ...
    for (int i = 0; i <= 3; i++) {
        ...
        if (chargeSum < 840 && chargeSum > 550) {
